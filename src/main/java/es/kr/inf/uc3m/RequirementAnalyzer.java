...
import org.moldeas.pscs.analyzers.PluralFilter;

public class RequirementAnalyzer extends Analyzer{


	protected static Set createStopWordsSet(){
		Set m_Words = new HashSet();
	...
	WordDelimiterFilterFactory df = new WordDelimiterFilterFactory();
	TrimFilterFactory tf = new TrimFilterFactory();
	...
	public TokenStream tokenStream(String arg0, Reader reader) {
	   ...
	   // result = new SpecialCharsFilter(result);
	    ...
	    result = new LengthFilter(result,1,400);
